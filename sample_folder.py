...
def main(mode, args):
    ...
    if mode == "SDE":
        ...
        if int(args.use_dc) == 1 and int(args.use_cg) == 0 and int(args.use_asd_pocs) == 0:
        ...
        if args.cfg_scale > 1.0:
            ...
            model_kwargs["null_class"] = args.num_classes
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--ckpt",
        type=str,
        default="/home/haodong/Project/sit/0200000.pt",
