...
def main(mode, args):
    ...
    if mode == "ODE":
        ...
        sample_fn = sampler.sample_sde(
            ...
            num_steps=args.num_sampling_steps,
            use_cg_dc=bool(args.use_cg_dc),
            use_asdpocs_dc=bool(args.use_asdpocs_dc),
        )
    ...
    # plt.imsave(f"AAPM_sample_256.png", np.abs(samples.squeeze().cpu().numpy()), cmap='gray')
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ckpt", type=str, default=r"D:\CT_rec\SiT\pretrained_models\Training_wo_CFG\0120000.pt",
