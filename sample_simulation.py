...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--ckpt",
        type=str,
        default=r"D:\CT_rec\SiT\pretrained_models\008-SiT-B-2-Linear-velocity-None\checkpoints\0200000.pt",
    ...
    parser.add_argument(
        "--input-dir",
        type=str,
        default=r"C:\Users\Haodong_Li\OneDrive - UMass Lowell (1)\Documents\GitHub\CDPIR\data\AAPM",
        help="Folder that contains the input images to reconstruct (.mat/.npy/.png/.jpg by default).",
    )
    parser.add_argument(
        "--output-dir",
        type=str,
        default=r"C:\Users\Haodong_Li\OneDrive - UMass Lowell (1)\Documents\GitHub\CDPIR\results",
        help="Folder to save reconstructed images. Defaults to <input-dir>/recon if omitted.",
    )
    parser.add_argument(
        "--ori-dir",
        type=str,
        default=r"C:\Users\Haodong_Li\OneDrive - UMass Lowell (1)\Documents\GitHub\CDPIR\results\ori",
