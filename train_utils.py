...
def parse_sde_args(parser):
    ...
    group.add_argument("--use-cg-dc", type=int, default=1, choices=[0, 1],
                        help="Apply the CG data consistency step when set to 1.")
    group.add_argument("--use-asdpocs-dc", type=int, default=1, choices=[0, 1],
                        help="Apply the ASD-POCS data consistency step when set to 1.")
